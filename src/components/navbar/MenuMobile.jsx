...
export default function MenuMobile({name, changeName, clearCookie, open}) {
  ...
  return (
    <div className={`flex flex-col content-center p-4 bg-neutral-800 text-white shadow-md shadow-black h-screen absolute right-0 z-10 ${open ? "" : "translate-x-full"} transition-all`}>
